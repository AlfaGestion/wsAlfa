...
/****** Object:  StoredProcedure [dbo].[sp_web_V_MV_CPTE]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_V_MV_CPTE]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_setTareas]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_setTareas]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_setRespuestaTarea]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_setRespuestaTarea]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_setExtensionTareas]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_setExtensionTareas]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_setCobranza]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_setCobranza]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getTransferenciasCaja]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getTransferenciasCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getTareas]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getTareas]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getTareaHelpdesk]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getTareaHelpdesk]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getStockDepositos]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getStockDepositos]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldoTJCaja]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldoTJCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldosStockPagination]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldosStockPagination]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldosStockCardTotal]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldosStockCardTotal]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldosStock]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldosStock]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldosCuentas]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldosCuentas]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldoConsolidadoCaja]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldoConsolidadoCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getRemitosTransportePendientesChofer]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getRemitosTransportePendientesChofer]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getPedidos]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getPedidos]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getListaDePrecios]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getListaDePrecios]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getLibroIva]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getLibroIva]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getIngresosEgresosCaja]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getIngresosEgresosCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getFichaStockArticulo]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getFichaStockArticulo]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getFamiliasArticulos]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getFamiliasArticulos]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getEstadosRemitosTransporte]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getEstadosRemitosTransporte]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDetalleVentasPorCpteCaja]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getDetalleVentasPorCpteCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDetallePorRubroCaja]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getDetallePorRubroCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDetallePorProductoCaja]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getDetallePorProductoCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDetalleEfectivoCaja]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getDetalleEfectivoCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDetalleDiarioCaja]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getDetalleDiarioCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDestinatariosTransporte]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getDestinatariosTransporte]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDatosEmpresa]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getDatosEmpresa]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getCuentaCorriente]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getCuentaCorriente]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getComprobantesCtaCte]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getComprobantesCtaCte]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getComprobantesCanceladosCaja]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getComprobantesCanceladosCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getComprobantes]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getComprobantes]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getClientesTransporte]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getClientesTransporte]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getChoferes]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getChoferes]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getArticulosPrecios]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getArticulosPrecios]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getAcumuladoVentasCaja]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_getAcumuladoVentasCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_creaLineaAsiento]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_creaLineaAsiento]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_CreaCobPorFactura]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_CreaCobPorFactura]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_CreaAsientoIngresoEgreso]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_CreaAsientoIngresoEgreso]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_CreaAplicacionCobranzaFactura]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_CreaAplicacionCobranzaFactura]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_CpteInsumos]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_CpteInsumos]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_CalificarRespuesta]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_CalificarRespuesta]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_AltaTarea]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_AltaTarea]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_AltaTabla]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_AltaTabla]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_altaCliente]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_altaCliente]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_AltaArticulo]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_AltaArticulo]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_ActualizaEstadoRemitoTransporte]    Script Date: 01/12/2022 11:17:17 ******/
DROP PROCEDURE [dbo].[sp_web_ActualizaEstadoRemitoTransporte]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getListaDePrecios_query]    Script Date: 14/03/2023 12:21:06 ******/
...
BEGIN
	...
	IF @idLista <> '' 
		...
		SET @rs = '
		SELECT TOP 200 codigo,descripcion,idfamilia,rutaimagen,nombre_familia,cant_of,dto_of,cant_of2,dto_of2, ''' + @muestraSinStock + ''' as mostrarsinstock,
	...
	ELSE
		SET @rs = '
		SELECT TOP 200 codigo,descripcion,idfamilia,rutaimagen,nombre_familia,cant_of,dto_of,cant_of2,dto_of2,presentacion, '''  + @muestraSinStock + ''' as mostrarsinstock,
...
BEGIN
	...
	INSERT INTO V_MV_CPTETAREAS
		...
		DESCRIPCIONADICIONAL,FECHAESTINICIO,SECUENCIA, USUARIO,IdTecnico)
	VALUES
		(@Tc, @IdComprobante, 0, dbo.FN_FMT_LEERCODIGO(LTRIM(RTRIM(@pidTarea)),4), @descTarea, @minutos, 0,
			@pObs, @FechaHoraGrabacion, 1, @USUARIO, @pIdTecnico)
...
BEGIN
    ...
    (SELECT TOP 1
		...
		AS Venta, b.Moneda, a.CantidadOf2 AS Cant_Of1, a.PRECIO9 AS Dto_Of1, a.CantidadOf3 AS Cant_Of2, a.PRECIO10 AS Dto_Of2, b.tasaiva , b.IdFamilia,
			...
			WHERE (ltrim(a.IdLista) = @idlista ) and b.SuspendidoV <>1 and b.Suspendido <>1) AS z) AS x
	WHERE  (ult_cambio>=@fechad and ult_cambio<=@fechah) 
		and (DESCRIPCION like '%' + @query + '%' or IdArticulo like  '%' + @query + '%')
	ORDER BY  Familia, DESCRIPCION
