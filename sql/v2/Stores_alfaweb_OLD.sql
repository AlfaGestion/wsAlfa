...
/****** Object:  StoredProcedure [dbo].[sp_web_V_MV_CPTE]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_V_MV_CPTE]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_setTareas]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_setTareas]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_setRespuestaTarea]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_setRespuestaTarea]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_setCobranza]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_setCobranza]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getTransferenciasCaja]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getTransferenciasCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getTareas]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getTareas]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getTareaHelpdesk]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getTareaHelpdesk]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getStockDepositos]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getStockDepositos]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldoTJCaja]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldoTJCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldosStockPagination]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldosStockPagination]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldosStockCardTotal]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldosStockCardTotal]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldosStock]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldosStock]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldosCuentas]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldosCuentas]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldoConsolidadoCaja]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldoConsolidadoCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getRemitosTransportePendientesChofer]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getRemitosTransportePendientesChofer]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getPedidos]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getPedidos]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getListaDePrecios]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getListaDePrecios]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getLibroIva]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getLibroIva]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getIngresosEgresosCaja]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getIngresosEgresosCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getFichaStockArticulo]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getFichaStockArticulo]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getFamiliasArticulos]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getFamiliasArticulos]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getEstadosRemitosTransporte]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getEstadosRemitosTransporte]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDetalleVentasPorCpteCaja]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getDetalleVentasPorCpteCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDetallePorRubroCaja]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getDetallePorRubroCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDetallePorProductoCaja]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getDetallePorProductoCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDetalleEfectivoCaja]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getDetalleEfectivoCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDetalleDiarioCaja]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getDetalleDiarioCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDestinatariosTransporte]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getDestinatariosTransporte]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDatosEmpresa]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getDatosEmpresa]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getCuentaCorriente]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getCuentaCorriente]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getComprobantesCtaCte]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getComprobantesCtaCte]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getComprobantesCanceladosCaja]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getComprobantesCanceladosCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getComprobantes]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getComprobantes]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getClientesTransporte]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getClientesTransporte]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getChoferes]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getChoferes]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getArticulosPrecios]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getArticulosPrecios]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getAcumuladoVentasCaja]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_getAcumuladoVentasCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_CpteInsumos]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_CpteInsumos]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_CalificarRespuesta]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_CalificarRespuesta]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_AltaTarea]    Script Date: 19/07/2022 11:48:29 ******/
DROP PROCEDURE [dbo].[sp_web_AltaTarea]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_ActualizaEstadoRemitoTransporte]    Script Date: 19/07/2022 11:48:29 ******/
	...
	(
		...
		ELSE
			BEGIN
				...
				IMPORTE=IMPORTE+ @IMPORTE_C_IVA, 
				IMPORTE_S_IVA=IMPORTE_S_IVA+(@pImporteUnitario*@pCantidad),
				ImporteInsumos=ImporteInsumos+(@importe*@pCantidad),
				ImporteIva=ImporteIva+@IMPORTE_IVA,
				NEtoGravado = NetoGravado+@NETO_GRAVADO,
				NetoNoGravado = 0
...
BEGIN
	...
	ELSE
		SET @rs = '
		SELECT TOP 50 codigo,descripcion,idfamilia,rutaimagen,nombre_familia,cant_of,dto_of,cant_of2,dto_of2,presentacion,
		CASE WHEN ''' + @ocultaPrecios + ''' = ''SI'' THEN ''0'' ELSE convert(varchar,convert(decimal(15,2),precio * coeficiente)) END as precio,
		''' + @ocultaPrecios + ''' as oculta_precio
		FROM (
...
BEGIN
	...
	(
		...
		[importe] [money],
		[usuario] [nvarchar] (13) COLLATE  Latin1_General_CI_AI
	)
...
BEGIN
    ...
    (SELECT TOP 1
		...
		FROM (SELECT a.IdArticulo, b.DESCRIPCION, b.Procedencia AS DescAdic, a.Precio4 AS Venta, b.Moneda, a.CantidadOf2 AS Cant_Of1, a.PRECIO9 AS Dto_Of1, a.CantidadOf3 AS Cant_Of2, a.PRECIO10 AS Dto_Of2, b.tasaiva , b.IdFamilia,
				(SELECT TOP (1)
					Descripcion
...
BEGIN
	...
	FROM V_MA_ARTICULOS LEFT JOIN S_TA_EQUIV on V_MA_ARTICULOS.IDARTICULO = S_TA_EQUIV.IDARTICULO
	...
	IF @coeficiente > 0 and @udPedido <> @udVenta AND @udPedido<>''
		BEGIN
			SET @real =isnull( (Select sum(Cant_BL) as Cant_BL from v_MV_stock where (anulado = 0 or anulado = null) and LTRIM(idarticulo) = ltrim(@idarticulo)),'0')
			SET @sugerido =  isnull(CONVERT(varchar(20), @real - @comprometido),'0')
		END
	ELSE
		BEGIN
			SET @real = isnull((SELECT isnull(sum(STOCK),0) FROM STK_MA_ARTICULOS
			WHERE ltrim(IDARTICULO) = ltrim(@idarticulo) group by idarticulo ),0)
	...
	IF @coeficiente > 0 and @udPedido <> @udVenta AND @udPedido<>''
		...
		UNION
		Select isnull(ltrim(a.idDEPOSITO),'''')  + '' '' + isnull(b.descripcion,'''') as deposito,convert(varchar,convert(decimal(15,2),isnull(sum(a.Cant_BL),0))) as stock
		from v_MV_stock a 
		LEFT JOIN V_TA_DEPOSITO b ON a.idDEPOSITO = b.idDeposito
		where (a.anulado = 0 or a.anulado = null) and LTRIM(a.idarticulo)=''' + @idarticulo + '''
		group by a.IDARTICULO,a.idDEPOSITO, b.Descripcion ) AS A WHERE deposito<>'''''
	ELSE
		SET @rs = '
		SELECT deposito, convert(varchar,convert(decimal(15,2),stock)) as stock FROM (
		SELECT ''@REAL'' as deposito, ''' + CONVERT(varchar(20),@real) + ''' as stock
		...
		SELECT ''@SUGERIDO'' as deposito,''' + @sugerido + ''' as stock
		UNION
		SELECT isnull(ltrim(a.DEPOSITO),'''')  + '' '' + isnull(b.descripcion,'''') as deposito, ISNULL(sum(a.stock / ''' + CONVERT(varchar(20),@coeficiente) + '''),0) as stock
...
BEGIN
	...
	IF @estado = 'P'
		SET @rs = '
		SELECT CONVERT(NVARCHAR(10),fecha,103) as fecha,fecha as fechaorden,id,descripcion,isnull(idtecnico,'''') as idtecnico,isnull(NombreTecnico,'''') as nombre_tecnico,idcomprobante,cuenta,nombre,isnull(idestado,'''') as idestado,isnull(estado,'''') as estado
