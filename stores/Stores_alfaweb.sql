...
/****** Object:  StoredProcedure [dbo].[sp_web_CpteInsumosV2]    Script Date: 12/06/24 01:33:28 ******/
DROP PROCEDURE [dbo].[sp_web_CpteInsumosV2]
GO
...
/****** Object:  StoredProcedure [dbo].[sp_web_CpteInsumos]    Script Date: 14/11/24 06:18:56 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[sp_web_setTareas]
	...
	@pDocumento                      varchar(250) = null,
	@pTelefono                       varchar(250) = null,
	@pResultado 					 smallint = NULL OUTPUT,
	@pMensaje 						 varchar(255) = NULL OUTPUT,
	@pIdCpte						 varchar(13) = NULL OUTPUT
AS
DECLARE @Tc NVARCHAR(4)
DECLARE @IdComprobante NVARCHAR(13)
DECLARE @nombre NVARCHAR(50)
...
IF @pDocumento <> ''
	SET @documentoNumero = @pDocumento
...
-------------------------------------------------------------------------------------------
-- RUTINA NUEVA, QUIZAS EN VEZ DE 2024 PUEDER IR LA VERSION V3 EJ sp_web_CpteInsumosV3
-------------------------------------------------------------------------------------------

CREATE PROCEDURE [dbo].[sp_web_CpteInsumosV2]
	@pIdCpte						 INT = null,
	@pIdArticulo					 NVARCHAR(25),
	@pCantidad						 FLOAT,
	@pCantidadBL     				 FLOAT,      -- agregado
	@pImporteUnitario				 MONEY,
	@pPorcDescuento                  VARCHAR(10),
	@pResultado 					 SMALLINT = NULL OUTPUT,
	@pMensaje 						 VARCHAR(255) = NULL OUTPUT,
...
BEGIN TRY
	...
	(
		...
		@total,
		@Costo,
		@idlista, @unidadBase, @pCantidad, @pCantidadBL , @cantKG, @Presentacion    
				)
		IF @@error <> 0 
			BEGIN
				ROLLBACK TRANSACTION
