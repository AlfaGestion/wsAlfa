...
/****** Object:  StoredProcedure [dbo].[sp_web_V_MV_CPTE]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_V_MV_CPTE]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_setTareas]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_setTareas]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_setRespuestaTarea]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_setRespuestaTarea]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_setExtensionTareas]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_setExtensionTareas]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_setCobranzaConPago]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_setCobranzaConPago]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_setCobranza]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_setCobranza]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getTransferenciasCaja]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getTransferenciasCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getTareas]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getTareas]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getTareaHelpdesk]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getTareaHelpdesk]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getStockDepositos]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getStockDepositos]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldoTJCaja]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldoTJCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldosStockPagination]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldosStockPagination]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldosStockCardTotal]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldosStockCardTotal]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldosStock]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldosStock]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldosCuentas]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldosCuentas]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getSaldoConsolidadoCaja]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getSaldoConsolidadoCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getRemitosTransportePendientesChofer]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getRemitosTransportePendientesChofer]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getPedidos]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getPedidos]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getListaDePrecios]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getListaDePrecios]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getLibroIva]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getLibroIva]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getIngresosEgresosCaja]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getIngresosEgresosCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getFichaStockArticulo]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getFichaStockArticulo]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getFamiliasArticulos]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getFamiliasArticulos]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getEstadosRemitosTransporte]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getEstadosRemitosTransporte]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDetalleVentasPorCpteCaja]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getDetalleVentasPorCpteCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDetallePorRubroCaja]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getDetallePorRubroCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDetallePorProductoCaja]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getDetallePorProductoCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDetalleEfectivoCaja]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getDetalleEfectivoCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDetalleDiarioCaja]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getDetalleDiarioCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDestinatariosTransporte]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getDestinatariosTransporte]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getDatosEmpresa]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getDatosEmpresa]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getCuentaCorriente]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getCuentaCorriente]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getComprobantesCtaCte]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getComprobantesCtaCte]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getComprobantesCanceladosCaja]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getComprobantesCanceladosCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getComprobantes]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getComprobantes]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getClientesTransporte]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getClientesTransporte]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getChoferes]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getChoferes]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getArticulosPrecios]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getArticulosPrecios]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_getAcumuladoVentasCaja]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_getAcumuladoVentasCaja]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_creaLineaAsiento]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_creaLineaAsiento]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_CreaCobranza]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_CreaCobranza]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_CreaCobPorFactura]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_CreaCobPorFactura]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_CreaAsientoIngresoEgreso]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_CreaAsientoIngresoEgreso]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_CreaAplicacionCobranzaFactura]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_CreaAplicacionCobranzaFactura]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_CreaAplicacion]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_CreaAplicacion]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_CpteInsumos]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_CpteInsumos]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_CalificarRespuesta]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_CalificarRespuesta]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_AplicacionCobranzaAutomatica]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_AplicacionCobranzaAutomatica]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_AltaTarea]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_AltaTarea]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_AltaTabla]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_AltaTabla]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_altaCliente]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_altaCliente]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_AltaArticulo]    Script Date: 11/01/2023 12:57:28 ******/
DROP PROCEDURE [dbo].[sp_web_AltaArticulo]
GO

/****** Object:  StoredProcedure [dbo].[sp_web_ActualizaEstadoRemitoTransporte]    Script Date: 11/01/2023 12:57:28 ******/
...
IF @pUd <> '' SET @pUd = dbo.FN_FMT_LEERCODIGO(LTRIM(RTRIM(@pUd)),4)
IF @pMarca <> '' SET @pMarca = dbo.FN_FMT_LEERCODIGO(LTRIM(RTRIM(@pMarca)),4)
IF @pRubro <> '' SET @pRubro = dbo.FN_FMT_LEERCODIGO(LTRIM(RTRIM(@pRubro)),4)
	...
	(
		...
		ELSE
			BEGIN
				...
				ImporteInsumos=isnull(ImporteInsumos,0)+(@importe*@pCantidad),
...
BEGIN TRANSACTION;
	...
	'CB', 0, @pFecha, @FechaHoraGrabacion, @USUARIO, '   1')
...
BEGIN
	...
	IF @idLista <> '' 
		...
		SET @rs = '
		SELECT TOP 50 codigo,descripcion,idfamilia,rutaimagen,nombre_familia,cant_of,dto_of,cant_of2,dto_of2, ''' + @muestraSinStock + ''' as mostrarsinstock,
		CASE WHEN ''' + @ocultaPrecios + ''' = ''SI'' THEN ''0'' ELSE convert(varchar,convert(decimal(15,2),precio * coeficiente)) END as precio,presentacion,
		''' + @ocultaPrecios + ''' as oculta_precio,stock
		 FROM (
		SELECT codigo,descripcion,idfamilia,rutaimagen,nombre_familia,cant_of,dto_of,cant_of2,dto_of2,coeficiente,isnull(presentacion,'''') as presentacion,
		CASE moneda 
		WHEN ''1'' THEN precio
		...
		ELSE precio END as precio,stock
		FROM (
		...
		ELSE a.precio' + @clasePrecio + ' END as precio,
	...
	ELSE
		SET @rs = '
		SELECT TOP 50 codigo,descripcion,idfamilia,rutaimagen,nombre_familia,cant_of,dto_of,cant_of2,dto_of2,presentacion, '''  + @muestraSinStock + ''' as mostrarsinstock,
		CASE WHEN ''' + @ocultaPrecios + ''' = ''SI'' THEN ''0'' ELSE convert(varchar,convert(decimal(15,2),precio * coeficiente)) END as precio,
		''' + @ocultaPrecios + ''' as oculta_precio,stock
		FROM (
		SELECT codigo,descripcion,idfamilia,rutaimagen,nombre_familia,0 as cant_of,0 as dto_of,0 as cant_of2,0 as dto_of2,coeficiente,presentacion,
		CASE moneda 
		WHEN ''1'' THEN precio
		WHEN ''2'' THEN precio * ' + @cotiz2 + '
		WHEN ''3'' THEN precio * ' + @cotiz3 + '
		...
		, b.precio' + @clasePrecio + ' as precio,isnull(d.coeficiente,1) as coeficiente,isnull(b.presentacion,'''') as presentacion,
...
BEGIN
    ...
    case when saldo <> 0 then ''Pendiente'' else ''Pagado'' end as estado
     FROM VE_CPTES_SALDOS_TODOS a LEFT JOIN V_MV_CPTE  b
    ...
    WHERE b.ANULADA=0 AND (a.TC<>''CB'' AND a.TC<>''CBFP'') ' + @WHERE + ' ORDER BY fechaorden DESC'

	/*SET @rs = '
	SELECT a.fecha as fechaorden, CONVERT(NVARCHAR(10),a.fecha,103) as fecha,a.tc + '' - '' + a.sucursal + a.numero + a.letra as comprobante,a.detalle,
    convert(varchar,convert(decimal(15,2),a.importe)) as importe,
    convert(varchar,convert(decimal(15,2),a.pago)) as pago,
    convert(varchar,convert(decimal(15,2),a.saldo)) as saldo,
    case when saldo <> 0 then ''Pendiente'' else ''Pagado'' end as estado
     FROM VE_CPTES_SALDOS a LEFT JOIN V_MV_CPTE  b
    ON a.TC=b.TC AND a.SUCURSAL = b.SUCURSAL AND a.NUMERO=b.NUMERO AND a.LETRA=b.LETRA  
    LEFT JOIN MA_CUENTASADIC c ON c.codigo = b.cuenta
    WHERE b.ANULADA=0  ' + @WHERE + ' ORDER BY fechaorden DESC'*/
...
BEGIN
    ...
    (SELECT TOP 1
			...
			Cant_Of1, Dto_Of1, Cant_Of2, Dto_Of2, IdFamilia, Familia, Ult_cambio, Venta, Moneda, Presentacion, TasaIVA
...
BEGIN
	...
	SET @comprometido = isnull((SELECT isnull(stock,0)
	FROM wsSysMobileStockComprometidoArticulos
...
BEGIN
	...
	DECLARE @type_field NVARCHAR(100)
	...
	SET @rs = '
	SELECT CONVERT(NVARCHAR(10),fecha,103) as fecha,id,descripcion,isnull(idtecnico,'''') as idtecnico,isnull(NombreTecnico,'''') as nombre_tecnico,idcomprobante,cuenta,nombre,isnull(idestado,'''') as idestado,isnull(estado,'''') as estado
    ...
    Select  FechaEstInicio as fecha, id, z.descripcion, IdTecnico , NombreTecnico , IDCOMPROBANTE , CUENTA, nombre,idestado, x.Descripcion as Estado, x.Color, x.Tipo, comprobanteorigen,ISNULL(CAST(descripcionadicional as NVARCHAR(MAX)) ,'''') as descripcionadicional,horas,solicitante  from (
    Select top ' +  @top  + ' a.FechaEstInicio, a.id, a.descripcion, a.idtecnico, c.Nombre as NombreTecnico,a.idcomprobante , b.cuenta,b.nombre, b.comprobanteorigen,ISNULL(CAST(a.descripcionadicional as NVARCHAR(MAX)) ,'''') as descripcionadicional,a.horas,b.solicitante,
    ...
    from v_mv_cptetareas a inner join v_mv_cpte b on a.tc = b.tc and a.idcomprobante = b.idcomprobante ' + @whCuenta + ' left outer  join v_ta_tecnicos c on a.IdTecnico = c.IdTecnico where a.FechaRealFin is null AND A.TC = ''OT'' 
    ' + @whPresupuesto + '
    ...
    UNION
    Select  FechaEstInicio, id, z.descripcion, IdTecnico , NombreTecnico , IDCOMPROBANTE , CUENTA,nombre, idestado, x.Descripcion as Estado, x.Color, x.Tipo,COMPROBANTEORIGEN,ISNULL(CAST(descripcionadicional as NVARCHAR(MAX)) ,'''') as descripcionadicional,horas,solicitante from (
    Select top ' +  @top  + ' a.FechaEstInicio, a.id, a.descripcion, a.idtecnico, c.Nombre as NombreTecnico,a.idcomprobante , b.cuenta,b.nombre, b.comprobanteorigen,ISNULL(CAST(a.descripcionadicional as NVARCHAR(MAX)) ,'''') as descripcionadicional,a.horas,b.solicitante,
    (select top 1 idestado from v_mv_status where a.IDCOMPROBANTE = V_MV_STATUS.IdComprobante and v_mv_status.tc = ''OT''
    ORDER BY v_mv_status.FechaHora Desc) as IdEstado
    from v_mv_cptetareas a inner join v_mv_cpte b on a.tc = b.tc and a.idcomprobante = b.idcomprobante ' + @whCuenta + ' left outer  join v_ta_tecnicos c on a.IdTecnico = c.IdTecnico where a.FechaRealFin <> '''' AND A.TC = ''OT''
    ' + @whPresupuesto + '
    order by a.fechaestinicio desc, a.idcomprobante desc 
    ) z left outer join v_ta_status x on z.idestado = x.codigoestado where (tipo <> ''A'' or tipo is null)
    ) as j ' + @whEstado + '  ORDER by fecha desc,id desc '
...
BEGIN
	...
	INSERT INTO V_MV_CPTETAREAS
		...
		DESCRIPCIONADICIONAL,FECHAESTINICIO,SECUENCIA, USUARIO,IdTecnico,FechaRealFin)
	VALUES
		(@Tc, @IdComprobante, 0, dbo.FN_FMT_LEERCODIGO(LTRIM(RTRIM(@pidTarea)),4), @descTarea, @minutos, 0,
			@pObs, @FechaHoraGrabacion, 1, @USUARIO, @pIdTecnico,@fechaRealFin)
