...
from functions.general_customer import (decode_id_account,
                                        ...
                                        get_last_budget_account, update_budget)
from functions.responses import set_response


class BudgetView(FlaskView):

    @route('/get/<string:account>/<int:db>/<int:id_contact>')
    def get_budget_file(self, account: str, db: int, id_contact: int):
        ...
        error, result = get_last_budget_account(data)
    ...
    def post(self):
        ...
        error = update_budget(data, payload)
        if error:
